...
pub const VTable = struct {
    ...
    bgsave: *const fn (*anyopaque, storages: []const Storage, origin: Store.TriggerOrigin) Error!void,
...
pub fn bgsave(self: SnapshotPersistence, storages: []const Storage, origin: Store.TriggerOrigin) Error!void {
